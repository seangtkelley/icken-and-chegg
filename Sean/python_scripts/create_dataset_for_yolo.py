...
yolo_utils.generate_sliding_windows(
    os.path.join(home_dir, 'config', 'yolo_train.txt'), 
    os.path.join(home_dir, 'config', 'yolo_416window_train.txt'), 
    os.path.join(home_dir, 'data', 'maps', 'sliding_windows_416'),
    max_boxes_per_window=20, window_size=(416, 416))

yolo_utils.generate_sliding_windows(
    os.path.join(home_dir, 'config', 'yolo_val.txt'), 
    os.path.join(home_dir, 'config', 'yolo_416window_val.txt'), 
    os.path.join(home_dir, 'data', 'maps', 'sliding_windows_416'),
    max_boxes_per_window=20, window_size=(416, 416))

yolo_utils.generate_sliding_windows(
    os.path.join(home_dir, 'config', 'yolo_test.txt'), 
    os.path.join(home_dir, 'config', 'yolo_416window_test.txt'), 
    os.path.join(home_dir, 'data', 'maps', 'sliding_windows_416'),
    max_boxes_per_window=20, window_size=(416, 416))
